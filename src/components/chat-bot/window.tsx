...
import { Bot, ImagePlus, Paperclip, Send } from 'lucide-react'
...
export const BotWindow = forwardRef<HTMLDivElement, Props>(
  (
    ...
    console.log(errors)
    return (
      <div className="h-[620px] w-[450px] flex flex-col bg-white rounded-xl mr-[80px] border-[1px] overflow-hidden">
        ...
        >
          <TabsContent value="chat">
            ...
            <div className="flex flex-col h-full">
              ...
              <form
                onSubmit={onChat}
                className="flex px-3 py-1 items-center justify-between bg-porcelain "
              >
